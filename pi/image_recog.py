...
def scale_image(frame, new_size=(180, 180)):
  # Get the dimensions
...
model_path = "/home/pi/robotics-level-4/all_models/new.tflite" 
label_path = "/home/pi/robotics-level-4/all_models/labels.txt"
top_k_results = 3
...
with picamera.PiCamera() as camera:
    ...
    path = "/home/pi/RPi-Romi-Robot/pi/data/out153.jpg"
    img = scale_image(path)
